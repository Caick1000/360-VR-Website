...
function mouseIn() {
	...
	for (let i = 1; i < $('.video').length; i++) {
		...
		// else if (currentId == 1) {
		// 	$('#video--'+i+'').animate({marginLeft:video.moveRight + 30}, 0);
		// } else if (currentId == $('.video').length) {
		// 	$('#video--'+i+'').css('margin-right', video.moveRight + 60);
		// }
...
function mouseOut() {
	...
	moveX('.video', 0);
	$('.video').css('margin-right', '2px');
	$('.video').css('margin-left', '2px');
